...
namespace Readarr.Api.V1.Config
{
    ...
    public class HostConfigController : RestController<HostConfigResource>
    {
        ...
        private bool IsValidSslCertificate(HostConfigResource resource)
        {
            ...
            try
            {
                cert = X509CertificateLoader.LoadPkcs12FromFile(resource.SslCertPath, resource.SslCertPassword, X509KeyStorageFlags.DefaultKeySet, Pkcs12LoaderLimits.Defaults);
            }
            catch
            {
                return false;
