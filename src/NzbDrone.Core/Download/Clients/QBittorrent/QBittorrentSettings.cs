...
namespace NzbDrone.Core.Download.Clients.QBittorrent
{
    ...
    public class QBittorrentSettings : IProviderConfig
    {
        ...
        [FieldDefinition(7, Label = "Post-Import Category", Type = FieldType.Textbox, Advanced = true, HelpText = "Category for ReadAIrr to set after it has imported the download. ReadAIrr will not remove the torrent if seeding has finished. Leave blank to keep same category.")]
