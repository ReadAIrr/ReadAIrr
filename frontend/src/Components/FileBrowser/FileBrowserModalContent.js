        ...
        >
          {
            isWindowsService &&
              <Alert
                ...
                kind={kinds.WARNING}
              >
                Mapped network drives are not available when running as a Windows Service, see the <Link className={styles.faqLink} to="https://readairr.com/docs/wiki/readarr/faq.html">FAQ</Link> for more information.
              </Alert>
          }
