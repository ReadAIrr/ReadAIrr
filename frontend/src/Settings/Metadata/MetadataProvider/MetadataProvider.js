            ...
            <FieldSet legend={translate('CalibreMetadata')}>
              <FormGroup>
                ...
                <FormInputGroup
                  ...
                  helpLink="https://readairr.com/docs/wiki/readarr/settings.html#write-metadata-to-book-files"
            ...
            <FieldSet legend={translate('AudioFileMetadata')}>
              <FormGroup>
                ...
                <FormInputGroup
                  ...
                  name="writeAudioTags"
                  helpTextWarning={translate('WriteBookTagsHelpTextWarning')}
                  helpLink="https://readairr.com/docs/wiki/readarr/settings.html#write-metadata-to-audio-files"
