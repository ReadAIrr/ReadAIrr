            ...
            isSchemaPopulated && !schemaError &&
              <div>
                ...
                <Alert kind={kinds.INFO}>
                  <div>
                    {'ReadAIrr supports custom conditions against the release properties below.'}
                  </div>
                  <div>
                    {'Visit the wiki for more details: '}
                    <Link to="https://readairr.com/docs/wiki/readarr/settings.html#custom-formats-2">{'Wiki'}</Link>
                  </div>
                </Alert>
